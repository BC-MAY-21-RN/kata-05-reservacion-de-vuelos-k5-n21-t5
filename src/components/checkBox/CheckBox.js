  ...
  return (
    <View>
      <View style={CheckBoxStyle.checkContainer}>
        ...
        <Text style={CheckBoxStyle.text}>I agree to the  <Text style={CheckBoxStyle.textUnderLine}>Terms</Text> and <Text style={CheckBoxStyle.textUnderLine}>Privacy Policy.</Text> *</Text>
      </View>
